...
export const EXPERIENCE: Role[] = [
  {
    ...
    points: [
      "Led an **AI-native oral assessment product** from discovery through pilots (scoping, prototype, onboarding) at **5 institutions with 9 instructors**, grading **1,000+ assessments**.",
      "Cut dynamic follow-up questions from the pilot spec after discovery showed instructors valued predictable, consistent question sets over adaptive depth; **the simpler flow shipped 2 weeks earlier**.",
      "Scoped a **rehearsed-vs-spontaneous speech classifier** to catch students reading AI-generated answers aloud. Trained on labelled B2C admissions-prep audio, it **reached 0.91 AUC**, with a precision-first flagging threshold to keep instructor review load manageable.",
      "Led **technical discovery** with non-technical educators, translating platform architecture into instructional and operational outcomes; **secured 5 of 6 pilot agreements**.",
      "Used pilot feedback to map the path from individual instructor use to **institution-wide adoption**, identifying institutional sign-off and **FERPA compliance** as the key requirements to scale.",
